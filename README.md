...
```shell
{
  "records":[
    {
      "Describe__c":"optional",
      "LastModifiedDate__c":"optional",
      "key__c":"required",
      "IsActive__c":false
    }
  ]
...
```shell
{
  "records":[
    {
      "tlnd__AuthType__c":"required",
      "tlnd__URL__c":"required",
      "tlnd__Token__c":"required",
      "tlnd__Active__c":false,
      "DevelperName":"required",
